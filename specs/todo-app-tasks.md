...
- [ ] T004 [P] Create Task dataclass in src/todo.py with id, title, description, completed fields
- [ ] T005 [P] Create TodoManager class in src/todo.py with in-memory storage
- [ ] T006 Create basic CLI structure in src/main.py
- [ ] T007 Implement auto-incrementing ID functionality in TodoManager
...
- [ ] T008 [US1] Implement add_task method in TodoManager class
- [ ] T009 [US1] Add CLI command parsing for 'add' command in main.py
- [ ] T010 [US1] Implement user input handling for add command
- [ ] T011 [US1] Add confirmation message after task is added
...
- [ ] T012 [US2] Implement list_tasks method in TodoManager class
- [ ] T013 [US2] Add CLI command parsing for 'list' command in main.py
- [ ] T014 [US2] Implement formatted display of tasks with status indicators
- [ ] T015 [US2] Handle case when no tasks exist
...
- [ ] T016 [US3] Implement mark_task_complete method in TodoManager class
- [ ] T017 [US3] Implement mark_task_incomplete method in TodoManager class
- [ ] T018 [US3] Add CLI command parsing for 'complete' command in main.py
- [ ] T019 [US3] Add CLI command parsing for 'incomplete' command in main.py
- [ ] T020 [US3] Implement user feedback for status change operations
...
- [ ] T021 [US4] Implement update_task method in TodoManager class
- [ ] T022 [US4] Add CLI command parsing for 'update' command in main.py
- [ ] T023 [US4] Implement user input handling for update command
- [ ] T024 [US4] Add confirmation message after task is updated
...
- [ ] T025 [US5] Implement delete_task method in TodoManager class
- [ ] T026 [US5] Add CLI command parsing for 'delete' command in main.py
- [ ] T027 [US5] Implement user feedback for deletion operations
...
- [ ] T028 [US6] Implement main REPL loop in main.py
- [ ] T029 [US6] Add 'help' command implementation
- [ ] T030 [US6] Add 'exit' command implementation
- [ ] T031 [US6] Implement error handling for invalid commands
...
- [ ] T032 Implement error handling for invalid task IDs
- [ ] T033 Implement error handling for invalid command formats
- [ ] T034 Add helpful feedback messages for all operations
- [ ] T035 Ensure app remains responsive and doesn't crash
